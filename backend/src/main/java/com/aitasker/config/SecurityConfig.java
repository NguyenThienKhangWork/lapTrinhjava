...
import com.aitasker.security.CustomUserDetailsService;
import com.aitasker.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/experts/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
            ...
            "http://127.0.0.1:3000",   // Docker Nginx loopback
            "http://localhost",         // Nginx port 80
            "http://127.0.0.1",         // Nginx port 80 loopback
            "http://localhost:8888",    // Landing page
            "http://127.0.0.1:8888"     // Landing page loopback
        ));
